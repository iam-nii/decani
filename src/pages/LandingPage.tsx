      ...
      {sections.map((section, index) => (
        <section
          ...
          className={`overflow-hidden w-full min-h-fit max-h-full
            ...
            ${
              index === 3
                ? "h-fit  2xl:h-[80dvh] overflow-x-visible overflow-y-visible"
                : ""
            }
            ${
              index === 4
                ? "h-fit min-h-[50dvh] md:min-h-[43dvh]  flex items-center"
                : ""
            }
            `}
        >
                ...
                <div className="w-full h-fit mx-10 my-40 space-y-20 lg:max-w-[1440px] px-10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-rows-1 lg:grid-cols-4 place-items-between gap-y-5 w-full md:space-x-5 lg:space-x-8 ">
                    {teamMembers.map((member, index) => (
                      <div
                        key={index}
                        className="w-fit max-w-[300px] min-h-[390px] flex flex-col"
                      >
                        <Avatar
                          src={member.image}
                          className=""
                    ...
                    <div className="w-full h-fit space-y-10 2xl:space-y-20">
                      ...
                      <div className="w-full sm:w-fit lg:min-w-[80%] h-fit min-h-[calc(35dvh)] xl:max-w-[80%] font-medium space-y-6 text-[16px]">
                        <p className="text-white h-fit w-fill leading-6 md:leading-7 text-justify">
                          Welcome to a world of boundless creativity and
                          innovation. At DECANI Creative Agency, we are more
                          than just a company; we are a collective of dreamers,
                          thinkers, and doers who are passionate about turning
                          ideas into reality. Our journey began with a vision to
                          redefine the creative landscape. Today, we stand at
                          the forefront of innovation, delivering cutting-edge
                          solutions to our clients worldwide. We are a team of
                          experts who thrive on challenges and embrace change,
                          dedicated to transforming your visions into
                          awe-inspiring realities. With a portfolio that spans
                          across various industries, we have a proven track
                          record of excellence in design, development, and
                          innovation. Our commitment to quality, ingenuity, and
                          client satisfaction drives us to explore new horizons
                          and push boundaries every day. Join us on this
                          exciting journey, and let's create, innovate, and
                          succeed together. DECANI CREATIVE AGENCY : Where
                          Creativity Knows No Bounds innovation.
                        </p>
                        <p className="h-fit text-white text-sm  leading-6 md:leading-7">
                          {" "}
                          Our commitment to quality, ingenuity, and client
                          satisfaction drives us to explore new horizons and
                          push boundaries every day. Join us on this exciting
                          journey, and let's create, innovate, and succeed
                          together.
                        </p>
                        <p className="h-fit text-white text-sm  leading-6 md:leading-7">
                          DECANI CREATIVE AGENCY : Where Creativity Knows No
                          Bounds
                        </p>
                      </div>
